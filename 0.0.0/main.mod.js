...
class pdipMod extends PolyMod { 
  ...
  init = function(polyModLoader) {
    ...
    polyModLoader.registerFuncMixin("UR", MixinType.INSERT, `{`, 'ActivePolyModLoader.getMod("pdip").trackId = OR(this, TR, "f");console.log(OR(this, TR, "f"));ActivePolyModLoader.getMod("pdip").playerName = JSON.parse(localStorage.getItem(`polytrack_v4_prod_user_${OR(this, MR, "f").profileSlot}`)).nickname;')
