...
class pdipMod extends PolyMod { 
  ...
  init = function(polyModLoader) {
    ...
    polyModLoader.registerClassMixin("$k.prototype", "refresh", MixinType.INSERT, "{", "ActivePolyModLoader.getMod('pdip').trackId = null;if (ActivePolyModLoader.getMod('pdip').stopWatch.ui) {ActivePolyModLoader.getMod('pdip').stopWatch.stop();}");
